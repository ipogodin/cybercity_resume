...
> This file describes every document in the `docs/` folder.
...
| File | Description |
|---|---|
| [HOW_TO_RESUME.md](HOW_TO_RESUME.md) | Guide for resuming the project in a new AI session — what to read, what commands to run, current state summary |
| [RESUME_PROMPT.md](RESUME_PROMPT.md) | Exact copy-paste prompt to use when starting a new AI chat session to restore full project context |
...
| File | Description |
|---|---|
| [ILLIA_POGODIN_2025.pdf](ILLIA_POGODIN_2025.pdf) | Resume PDF — the actual resume document this website is based on |
| [ILLIA_POGODIN_2025.docx](ILLIA_POGODIN_2025.docx) | Resume Word document — editable source version of the resume |
