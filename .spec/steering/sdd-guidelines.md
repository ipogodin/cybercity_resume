...
- [ ] Use dependency audit tools (`npm audit`)
...
// Retry because the external API has rate limits
...
1. Mark task as complete in `.spec/specs/{feature}/tasks.md`
...
- [ ] All tests pass
- [ ] Code coverage >= 80% on `src/lib/server/`
- [ ] No lint/type errors (`npm run check` passes)
- [ ] OWASP security checklist verified
- [ ] SOLID principles applied
- [ ] Code self-documenting; comments explain WHY only

## Common Anti-Patterns to Avoid

| Anti-Pattern | Problem | Solution |
|---|---|---|
| **God Class** | Class does too much | Split by responsibility (SRP) |
| **Feature Envy** | Method uses another class's data extensively | Move method to that class |
| **Primitive Obsession** | Using primitives for domain concepts | Create value objects / typed interfaces |
...
| **Long Methods** | Methods doing too much | Split into smaller functions |
