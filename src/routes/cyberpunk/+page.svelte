<script>
	...
	function getHubSigns() {
		return [
			{ text: 'Projects Alley', direction: 'north', color: 'cyan', position: 'top', route: '/cyberpunk/projects' },
			{ text: 'Contact Terminal', direction: 'east', color: 'purple', position: 'right', route: '/cyberpunk/contact' },
			{ text: 'Experience Avenue', direction: 'south', color: 'pink', position: 'bottom', route: '/cyberpunk/experience' },
			{ text: 'Skills District', direction: 'west', color: 'purple', position: 'left', route: '/cyberpunk/skills' }
		];
	}
